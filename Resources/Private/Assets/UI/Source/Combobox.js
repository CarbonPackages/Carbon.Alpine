...
function handleRoot(el, Alpine) {
    Alpine.bind(el, {
        "x-id"() {
            return ["headlessui-combobox-button", "headlessui-combobox-options", "headlessui-combobox-label"];
        },
        "x-list": "__value",
        "x-modelable": "__value",
        "x-data"() {
...
function handleInput(el, Alpine) {
    Alpine.bind(el, {
        "x-ref": "__input",
        ":id"() {
            return this.$id("headlessui-combobox-input");
        },
        role: "combobox",
        tabindex: "0",
        ":aria-controls"() {
            return this.$data.__optionsEl && this.$data.__optionsEl.id;
        },
        ":aria-expanded"() {
            return this.$data.__disabled ? undefined : this.$data.__isOpen;
        },
        ":aria-activedescendant"() {
            return this.$data.$list.activeEl ? this.$data.$list.activeEl.id : null;
        },
        ":aria-labelledby"() {
        ...
        "@keydown"(e) {
            this.$list.handleKeyboardNavigation(e);
        },
        "@keydown.down"(e) {
            if (!this.$data.__isOpen) this.$data.__open();
        },
        "@keydown.up"(e) {
            if (!this.$data.__isOpen) this.$data.__open();
        },
...
function handleButton(el, Alpine) {
    Alpine.bind(el, {
        "x-ref": "__button",
        ":id"() {
            return this.$id("headlessui-combobox-button");
        },
        "aria-haspopup": "true",
        ":aria-labelledby"() {
        ...
        ":aria-expanded"() {
            return this.$data.__disabled ? null : this.$data.__isOpen;
        },
        ":aria-controls"() {
            return this.$data.__optionsEl ? this.$data.__optionsEl.id : null;
        },
        ":disabled"() {
...
function handleLabel(el, Alpine) {
    Alpine.bind(el, {
        "x-ref": "__label",
        ":id"() {
            return this.$id("headlessui-combobox-label");
        },
        "@click"() {
...
function handleOptions(el, Alpine) {
    Alpine.bind(el, {
        ...
        role: "listbox",
        ":id"() {
            return this.$id("headlessui-combobox-options");
        },
        ":aria-labelledby"() {
            return this.$id("headlessui-combobox-button");
        },
        ":aria-activedescendant"() {
            return this.$list.activeEl ? this.$list.activeEl.id : null;
        },
        "x-show"() {
...
function handleOption(el, Alpine, directive, evaluate) {
    ...
    Alpine.bind(el, {
        ...
        ":id"() {
            return this.$id("headlessui-combobox-option");
        },
        ":tabindex"() {
            return this.$item.disabled ? undefined : "-1";
        },
        ":aria-selected"() {
...
function registerListStuff(Alpine) {
    Alpine.directive("list", (el, { expression, modifiers }, { evaluateLater, effect }) => {
        ...
        el._x_listState = {
            ...
            get active() {
                return this.reactive.active;
            },
            get selected() {
                return this.reactive.selected;
            },
            get activeEl() {
            ...
            items: [],
            get filteredEls() {
                return this.items.filter((i) => !i.disabled).map((i) => i.el);
            },
            ...
            prev() {
                ...
                let el = this.wrap
                    ? index - 1 < 0
                        ? this.filteredEls[this.filteredEls.length - 1]
                        : this.filteredEls[index - 1]
                    : index - 1 < 0
                    ? this.filteredEls[0]
                    : this.filteredEls[index - 1];
