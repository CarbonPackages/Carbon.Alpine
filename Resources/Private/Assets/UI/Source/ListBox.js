import { generateContext, renderHiddenInputs } from "./ListContext";
        ...
        "x-data"() {
            return {
                ...
                init() {
                    ...
                    this.__context = generateContext(this.__isMultiple, this.__orientation, Alpine);
                    ...
                    queueMicrotask(() => {
                        ...
                        queueMicrotask(() => {
                            ...
                            Alpine.effect(() => {
                                ...
                                this.__inputName &&
                                    renderHiddenInputs(this.$el, this.__inputName, this.__value, Alpine);
                            });
                        });
                    });
                },
