...
function handleItems(el, Alpine) {
    Alpine.bind(el, {
        ...
        "@keydown"(e) {
            dom.search(Alpine, this.$refs.__items, e.key, (el) => el.__activate());
        },
        "@keydown.down.stop.prevent"() {
        ...
        "@keydown.home.stop.prevent"() {
            dom.first(Alpine, this.$refs.__items, (el) => el.__activate());
        },
        "@keydown.end.stop.prevent"() {
            dom.last(Alpine, this.$refs.__items, (el) => el.__activate());
        },
