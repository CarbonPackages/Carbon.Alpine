// node_modules/.pnpm/@alpinejs+intersect@3.17.4/node_modules/@alpinejs/intersect/dist/module.esm.js
...
function observeForDwell(el, value, modifiers, evaluate, cleanup, options, threshold) {
    ...
    let beginDwell = () => {
        if (dwellTimeout !== void 0 || hasEvaluated || document.hidden || !lastEntry) return;
...
function meetsDwellThreshold(entry, value, threshold) {
    let meetsThreshold =
        threshold === 0 ? entry.isIntersecting : entry.isIntersecting && entry.intersectionRatio >= threshold;
...
// Resources/Private/Source/Plugins/Intersect.js
var Intersect_default = module_default;
export { Intersect_default as default };
