// node_modules/.pnpm/@alpinejs+morph@3.15.11/node_modules/@alpinejs/morph/dist/module.esm.js
...
function createMorphContext(options = {}) {
    ...
    context.differentElementNamesTypesOrKeys = function (from, to) {
        return (
            from.nodeType != to.nodeType || from.nodeName != to.nodeName || context.getKey(from) != context.getKey(to)
        );
    };
...
// Resources/Private/Source/Plugins/Morph.js
var Morph_default = module_default;
export { Morph_default as default };
