// node_modules/.pnpm/@alpinejs+sort@3.15.12/node_modules/@alpinejs/sort/dist/module.esm.js
    ...
    Alpine.directive("sort", (el, { value, modifiers, expression }, { effect, evaluate, cleanup }) => {
        ...
        let preferences = {
            ...
            useHandles:
                ...
                Array.from(el.querySelectorAll("template:not(svg template)")).some((tmpl) =>
...
// Resources/Private/Source/Plugins/Sort.js
var Sort_default = module_default;
