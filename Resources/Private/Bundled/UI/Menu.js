// Resources/Private/Source/UI/Menu.js
...
function handleItems(el, Alpine) {
    Alpine.bind(el, {
        ...
        "@keydown.down.stop.prevent"() {
            if (this.$data.__activeEl) dom.next(Alpine, this.$data.__activeEl, (el2) => el2.__activate());
            else dom.first(Alpine, this.$refs.__items, (el2) => el2.__activate());
        },
        "@keydown.up.stop.prevent"() {
            if (this.$data.__activeEl) dom.previous(Alpine, this.$data.__activeEl, (el2) => el2.__activate());
            else dom.last(Alpine, this.$refs.__items, (el2) => el2.__activate());
        },
