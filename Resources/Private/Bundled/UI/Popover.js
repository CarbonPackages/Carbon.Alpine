// Resources/Private/Source/UI/Popover.js
function Popover_default(Alpine) {
    Alpine.directive("popover", (el, directive, { evaluate }) => {
        if (!directive.value) handleRoot(el, Alpine, evaluate);
        ...
        "x-data"() {
            return {
                ...
                __close(el2) {
                    ...
                    if (document.activeElement.isSameNode(el2)) return;
        ...
        "@keyup.tab"(e) {
            if (this.$data.__isOpen) {
                ...
                if (
                    ...
                    !this.$data.__buttonEl.contains(lastEl) &&
                    !this.$data.__panelEl.contains(lastEl) && // Also make sure it appeared "after" this button in the DOM.
                    lastEl &&
