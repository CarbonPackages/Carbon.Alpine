// node_modules/.pnpm/alpinejs@3.16.2/node_modules/alpinejs/dist/module.esm.js
...
function compareJobs(a, b, depths) {
    ...
    let depthDifference =
        getElementDepth(a._x_schedulerPriority.el, depths) - getElementDepth(b._x_schedulerPriority.el, depths);
...
function setClassesFromObject(el, classObject) {
    let forAdd = Object.entries(classObject)
        .flatMap(([classString, bool]) => (bool ? splitClasses(classString) : false))
        .filter(Boolean);
